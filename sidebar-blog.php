...
<div class="content_right">
	...
	<div class="tabprice">
		...
		<ul class="tabnavig">
			<li><a href="#priceblock1"><?php _e( 'Popüler', APP_TD ); ?></a></li>
			<li><a href="#priceblock2"><?php _e( 'En İyi Yorumlar', APP_TD ); ?></a></li>
			<li><a href="#priceblock3"><?php _e( 'Etiketler', APP_TD ); ?></a></li>
		</ul>
