...
<div class="content_right">
	...
	<div class="tabprice">
		...
		<ul class="tabnavig">
			<?php if ( $gmap_active ) { ?><li><a href="#priceblock1"><span class="big"><?php _e( 'Google Map', APP_TD ); ?></span></a></li><?php } ?>
			<li><a href="#priceblock2"><span class="big"><?php _e( 'İlan İletişim', APP_TD ); ?></span></a></li>
			<li><a href="#priceblock3"><span class="big"><?php _e( 'Yayıncı', APP_TD ); ?></span></a></li>
		</ul>
		...
		<div id="priceblock2" class="sidebar-block">
			...
			?>
				<div class="pad25"></div>
				<p class="dashicons-before contact_msg center"><strong><?php _e( 'Bu reklam hakkında bilgi almak için giriş yapmış olmanız gerekiyor.', APP_TD ); ?></strong></p>
		...
		<div id="priceblock3" class="sidebar-block">
			...
			<div class="postertab">
				...
				<?php else: ?>
					...
					<li><?php _e( 'Bu Yazar Tarafından Paylaşılan Başka Gönderi Bulunamadı.', APP_TD ); ?></li>
