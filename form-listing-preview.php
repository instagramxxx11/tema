				...
				<div class="shadowblock">
					...
					<div id="step2">
						...
						<form name="mainform" id="mainform" class="form_step steps-review" action="<?php echo appthemes_get_step_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<p class="terms">
								<?php _e( 'Devam Ederek Aşağıdaki Sözleşmeyi ve Kullanım Koşullarını Kabul Etmiş Olursunuz.', APP_TD ); ?>
								<br />
								<?php _e( 'IP numaranız sistem tarafından kayıt altına alınmıştır.:', APP_TD ); ?> <?php echo appthemes_get_ip(); ?>
							</p>
