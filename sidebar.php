		...
		<div id="welcome_widget" class="shadowblock_out">
			...
			<div class="shadowblock">
				...
				<?php if ( ! is_user_logged_in() ) { ?>
					...
					<a href="<?php echo appthemes_get_registration_url(); ?>" class="btn_orange"><?php _e( 'Üye Ol Yavrum.!', APP_TD ); ?></a>
				...
				<?php } else { ?>
					...
					<div class="user">
						...
						<p class="welcome-back"><?php _e( 'Tekrar Hoşgeldin,', APP_TD ); ?> <strong><?php echo $current_user->display_name; ?></strong>.</p>
